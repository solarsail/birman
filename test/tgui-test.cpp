...
void loadWidgets( tgui::Gui& gui )
{
    ...
    editBoxUsername->load("/usr/local/share/tgui-0.6/widgets/Black.conf");
    ...
    button->load("/usr/local/share/tgui-0.6/widgets/Black.conf");
...
int main()
{
    ...
    gui.setGlobalFont("/usr/local/share/tgui-0.6/fonts/DejaVuSans.ttf");
